#This is actually the fourth version, where it's working well, and is generally a complete,
#functional program. The only difference between this and the last is the amount of markup
